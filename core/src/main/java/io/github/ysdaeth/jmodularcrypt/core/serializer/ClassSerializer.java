 ...
 * and storing serialization and deserialization function implementation provided
 * by serializer based on the class logic.
 */
final class ClassSerializer {
     ...
     * @return deserialized object from sections
     */
